...
import com.notheif.utils.Communication;
import com.notheif.utils.ComponentBuilder;
import com.notheif.utils.Input;
import com.notheif.utils.MessageUtils;
import com.notheif.utils.Numbers;
...
public class ConfigSection extends ConfigGUI {
	...
	public List<PagedItem> Contents() {
		...
		this.configSection.getKeys(false).forEach(i -> {
			...
			ItemStack section = new ItemStack(Material.valueOf(NoTheif.getInstance().configManager.configs.Sections));
			ItemStack ints = new ItemStack(Material.valueOf(NoTheif.getInstance().configManager.configs.Numbers));
			ItemStack text = new ItemStack(Material.valueOf(NoTheif.getInstance().configManager.configs.Text));
			ItemStack booleanON = new ItemStack(Material.valueOf(NoTheif.getInstance().configManager.configs.BooleanON));
			ItemStack booleanOFF = new ItemStack(Material.valueOf(NoTheif.getInstance().configManager.configs.BooleanOFF));
			ItemStack lists = new ItemStack(Material.valueOf(NoTheif.getInstance().configManager.configs.Lists));
					...
					execution = () -> {
						...
						Communication.applyInput(player, new Input() {
							...
							public void onRecieve(String o) {
								...
								Bukkit.getScheduler().callSyncMethod(NoTheif.getInstance(), new Callable<Object>() {
									@Override
