...
import com.notheif.placeholder.time.TimeFormater;
...
public class TagFactory{
	...
	public String playerParse(String parser) {
		...
		parser = parser.replace("%prefix%", NoTheif.getInstance().configManager.messages.prefix);
